...
| :--- | :--- |
| **Security Engineering** | eBPF (CO-RE), Linux Internals, Rootkit Analysis, DFIR |
| **Artificial Intelligence** | LLM fine-tuning, RAG, AI-driven automation, PyTorch |
| **Languages** | Go, C, Python, Bash, ARM64/x86_64 Assembly |
| **Ecosystem** | Docker, GitHub Actions, Linux Kernel Development |
